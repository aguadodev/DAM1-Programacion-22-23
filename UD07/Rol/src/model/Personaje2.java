...
public class Personaje2 implements Comparable {
    ...
    public Personaje2(String nombre, String raza, int fuerza, int agilidad, int constitucion, int nivel,
    ...
    public Personaje2(String nombre, String raza, int fuerza, int agilidad, int constitucion) {
        this(nombre, raza, fuerza, agilidad, constitucion, 1, 0, constitucion + 50);
    }

    public Personaje2(String nombre, String raza) {
    ...
    public boolean equals(Object obj) {
        Personaje2 otro = (Personaje2)obj;
    ...
    static Personaje2[] sortPuntosVidaDesc(Personaje2[] personajes){
        Personaje2[] A = Arrays.copyOf(personajes, personajes.length);
    ...
    static Personaje2[] sortPuntosVidaAsc(Personaje2[] personajes){
        Personaje2[] A = Arrays.copyOf(personajes, personajes.length);
    ...
    public int compareTo(Object o) {
        int res = nombre.compareTo(((Personaje2) o).nombre);
        if (res == 0)
            return puntosVida - ((Personaje2) o).puntosVida;
        else
            return res;
    }
