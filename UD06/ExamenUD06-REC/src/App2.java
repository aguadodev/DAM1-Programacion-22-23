...
public class App2 {
    public static void main(String[] args) {
        ...
        Coche coche1 = new Coche("Seat Ibiza", "Negro", 5, "FDA1234", "DIESEL", "C");
        // Crea un conductor indicando el nombre y el coche que conduce
        Conductor conductor1 = new Conductor("Uxía", "09/02/2017", coche1);
        ...
        LocalDateTime fechaHoraSalida = LocalDateTime.of(2023, 01, 30, 07, 05, 00);
